...
export const PLANS: Record<PlanTier, {
  ...
  whatsapp: {
    ...
    firstMonthLabel: '$39.000 primer mes',
    publicLabel: 'Desde $49.000 / mes',
  ...
  email: {
    ...
    firstMonthLabel: '$79.000 primer mes',
  ...
  social: {
    name: 'Multicanal',
    priceLabel: '$120.000/mes',
    firstMonthLabel: '$99.000 primer mes',
